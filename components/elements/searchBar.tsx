  ...
  return (
    <form className="flex items-center">
      ...
      <button
        type="submit"
        onClick={onClick}
        className="p-2.5 ml-2 text-sm font-medium text-white bg-red-700 rounded-lg border border-red-700 hover:bg-red-800  focus:outline-none  dark:bg-red-600 dark:hover:bg-red-700 "
      >
        <svg
          className="w-5 h-5"
          fill="none"
